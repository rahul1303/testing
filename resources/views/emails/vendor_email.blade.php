...
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="e4e4e4"><tr><td>
            <table id="main" width="600" align="center" cellpadding="0" cellspacing="15" bgcolor="ffffff">
                ...
                <tr>
                    <td>
                        <table id="content-2" cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                <td width="570">
                                    <h3 style="color:dodgerblue">Hey {{ $venue->manager_name }}!</h3>
                                </td>
                            </tr>
                            <tr>
                                <td width="570">
                                    <p>
                                        There is a new booking on your venue.Below are the customer and booking details
                                        <br><br>The order is booked on {{ $booking_date_time }}
                                        <br><br>This order is booked on {{ $booking_date_time }}
                                    </p>
                                </td>
                            </tr>
                        </table><!-- content-2 -->
                ...
                <tr>
                    <td height="5"><h2>Customer Details</h2></td>
                </tr>
                <tr>
                    <td>
                        <table id="content-3" cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                <td width="900" valign="top"  style="padding:5px;">
                                    <b>Customer Name : </b>{{ $venue->venue_name}}
                                </td>
                            </tr>
                            <tr>
                                <td width="900" valign="top"  style="padding:5px;">
                                    <b>Contact : </b> 0{{ $customer_name }}
                                </td>
                            </tr>
                            <tr>
                                <td width="900" valign="top"  style="padding:5px;">
                                    <b>Email : </b> 0{{ $customer_email }}
                                </td>
                            </tr>
                        </table><!-- content-3 -->
                    </td>
                ...
                <tr>
                    <td>
                        <table id="content-3" cellpadding="0" cellspacing="0" align="center">
                            ...
                            <tr>
                                <td width="900" valign="top"  style="padding:5px;">
                                    <b>Total amount : </b> Rs {{ $total_cost}}
                                </td>
                            </tr>
                            <tr>
                                <td width="900" valign="top"  style="padding:5px;">
                                    <b>Money from customer : </b> Rs {{ $final_cost-$advance_payment}}
                                </td>
                            </tr>
                            <tr>
                                <td width="900" valign="top"  style="padding:5px;">
                                    <b>Money from bashindia : </b> Rs {{ $bash}}
                                </td>
                            </tr>
                            <tr>
                                <td width="900" valign="top"  style="padding:5px;">
